...
import { initPort } from './fx/port.js';
...
const portCanvas = document.querySelector('.hero-port');
const portVideo = document.querySelector('.hero-video');
if (portCanvas) tryInit('port', () => initPort(portCanvas, portVideo, { reduceMotion, small }));
